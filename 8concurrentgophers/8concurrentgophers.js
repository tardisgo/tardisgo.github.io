...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("assets/bigpile.png",loader);
	ApplicationMain.total++;
	var loader1 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/empty.png",loader1);
	ApplicationMain.total++;
	var loader2 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/emptypile.png",loader2);
	ApplicationMain.total++;
	var loader3 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/full.png",loader3);
	ApplicationMain.total++;
	var loader4 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/function.png",loader4);
	ApplicationMain.total++;
	var loader5 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/gopher.png",loader5);
	ApplicationMain.total++;
	var loader6 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/gophercolor16x16.png",loader6);
	ApplicationMain.total++;
	var loader7 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/gophercolor16x16flipped.png",loader7);
	ApplicationMain.total++;
	var loader8 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/oven.png",loader8);
	ApplicationMain.total++;
	var loader9 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/pick.png",loader9);
	ApplicationMain.total++;
	var loader10 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/shovel.png",loader10);
	ApplicationMain.total++;
	var loader11 = new flash.display.Loader();
	ApplicationMain.loaders.set("assets/smallpile.png",loader11);
	ApplicationMain.total++;
...
var Main = function() {
	...
	this.headline = new flash.text.TextField();
	this.headline.selectable = true;
	this.headline.set_x(300);
	this.headline.set_y(10);
	this.headline.set_width(300);
	this.headline.set_text("TARDIS Go example; see tardisgo.github.io");
	this.headline.set_textColor(32768);
	this.addChild(this.headline);
	this.Code = new flash.display.Sprite();
	this.Code.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/function.png")));
	this.Code.set_x(200);
	this.Code.set_y(110);
	this.addChild(this.Code);
	this.Logo1 = new flash.display.Sprite();
	this.Logo1.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/gophercolor16x16.png")));
	this.Logo1.set_x(230);
	this.Logo1.set_y(140);
	this.addChild(this.Logo1);
	this.Logo2 = new flash.display.Sprite();
	this.Logo2.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/gophercolor16x16flipped.png")));
	this.Logo2.set_x(540);
	this.Logo2.set_y(140);
	this.addChild(this.Logo2);
	this.whatToDo = new flash.text.TextField();
	this.whatToDo.selectable = false;
	this.whatToDo.set_x(10);
	this.whatToDo.set_y(130);
	this.whatToDo.set_width(200);
	this.whatToDo.set_height(200);
	this.whatToDo.set_text("All animated gophers are \nrunning the Go code on the right.\nThe logos show where the 2 above\ngophers each are in that code now.\nThis Go code is running live,\ntranspiled into " + tardis.Go.Platform());
	this.whatToDo.set_textColor(32768);
	this.addChild(this.whatToDo);
	this.bigpile = [null,null,null,null];
	this.oven = [null,null,null,null];
	this.Books = [null,null,null,null];
	this.Sprite1 = [null,null,null,null];
	this.Sprite2 = [null,null,null,null];
	this.lineOffsets = [0,210,305,400];
	var _g = 0;
	while(_g < 4) {
		var l = _g++;
		this.bigpile[l] = new flash.display.Sprite();
		this.bigpile[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/bigpile.png")));
		this.bigpile[l].set_x(10);
		this.bigpile[l].set_y(20 + this.lineOffsets[l]);
		this.addChild(this.bigpile[l]);
		this.oven[l] = new flash.display.Sprite();
		this.oven[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/oven.png")));
		this.oven[l].set_x(690);
		this.oven[l].set_y(this.lineOffsets[l]);
		this.addChild(this.oven[l]);
		this.Books[l] = new flash.display.Sprite();
		this.Books[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/smallpile.png")));
		this.Books[l].set_x(this.bx);
		this.Books[l].set_y(this.by + this.lineOffsets[l]);
		this.addChild(this.Books[l]);
		this.Sprite1[l] = new flash.display.Sprite();
		this.Sprite1[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
		this.Sprite1[l].set_x(this.s1x);
		this.Sprite1[l].set_y(this.s1y + this.lineOffsets[l]);
		this.addChild(this.Sprite1[l]);
		this.Sprite2[l] = new flash.display.Sprite();
		this.Sprite2[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
		this.Sprite2[l].set_x(this.s2x);
		this.Sprite2[l].set_y(this.s2y + this.lineOffsets[l]);
		this.addChild(this.Sprite2[l]);
	}
	this.textField = new flash.text.TextField();
	this.textField.selectable = true;
	this.textField.set_x(420);
	this.textField.set_y(195);
	this.textField.set_width(400);
	this.textField.set_height(50);
	this.textField.set_textColor(32768);
	this.textField.set_text("Inspired by \"Concurrency is not Parallelism (it's better)\" - Rob Pike\nhttp://concur.rspace.googlecode.com/hg/talk/concur.html");
	this.addChild(this.textField);
	this.s1laststatus = [0,0,0];
	this.s2laststatus = [0,0,0];
	this.bookslaststatus = [true,true,true];
	tardis.Go.init();
	tardis.Go_main_StartGophers.callFromHaxe();
	this.goTimer = new flash.utils.Timer(25);
...
Main.prototype = $extend(flash.display.Sprite.prototype,{
	goTimerEvent: function(e) {
		...
		while(_g < 4) {
			var l = _g++;
			if(tardis.Go.main_smallpiles.ref()[l].hasContents() != this.bookslaststatus[l]) {
				this.bookslaststatus[l] = tardis.Go.main_smallpiles.ref()[l].hasContents();
				this.Books[l].removeChildAt(0);
				if(tardis.Go.main_smallpiles.ref()[l].hasContents() == true) this.Books[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/smallpile.png"))); else this.Books[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/emptypile.png")));
			}
			if((tardis.Go.main_Sprite1state.ref()[l] | 0) != this.s1laststatus[l]) {
				this.Sprite1[l].removeChildAt(0);
				this.s1laststatus[l] = tardis.Go.main_Sprite1state.ref()[l] | 0;
				if(l == 0) this.Logo1.set_y(140 + 15 * this.s1laststatus[l]);
				if(this.s1laststatus[l] == tardis.Go.main_Pick) this.Sprite1[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
				if(this.s1laststatus[l] == tardis.Go.main_Full) this.Sprite1[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/full.png")));
				if(this.s1laststatus[l] == tardis.Go.main_Shovel) this.Sprite1[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/shovel.png")));
				if(this.s1laststatus[l] == tardis.Go.main_Empty) this.Sprite1[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/empty.png")));
			}
			this.Sprite1[l].set_x(this.s1x + tardis.Go.main_Sprite1X.ref()[l]);
			this.Sprite1[l].set_y(this.s1y + tardis.Go.main_Sprite1Y.ref()[l] + this.lineOffsets[l]);
			if((tardis.Go.main_Sprite2state.ref()[l] | 0) != this.s2laststatus[l]) {
				this.Sprite2[l].removeChildAt(0);
				this.s2laststatus[l] = tardis.Go.main_Sprite2state.ref()[l] | 0;
				if(l == 0) this.Logo2.set_y(140 + 15 * this.s2laststatus[l]);
				if(this.s2laststatus[l] == tardis.Go.main_Pick) this.Sprite2[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
				if(this.s2laststatus[l] == tardis.Go.main_Full) this.Sprite2[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/full.png")));
				if(this.s2laststatus[l] == tardis.Go.main_Shovel) this.Sprite2[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/shovel.png")));
				if(this.s2laststatus[l] == tardis.Go.main_Empty) this.Sprite2[l].addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/empty.png")));
			}
			this.Sprite2[l].set_x(this.s2x + tardis.Go.main_Sprite2X.ref()[l]);
			this.Sprite2[l].set_y(this.s2y + tardis.Go.main_Sprite2Y.ref()[l] + this.lineOffsets[l]);
		}
	}
	,__class__: Main
});
...
var DefaultAssetLibrary = function() {
	...
	DefaultAssetLibrary.path.set("assets/bigpile.png","assets/bigpile.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/bigpile.png",value);
	DefaultAssetLibrary.path.set("assets/empty.png","assets/empty.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/empty.png",value);
	DefaultAssetLibrary.path.set("assets/emptypile.png","assets/emptypile.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/emptypile.png",value);
	DefaultAssetLibrary.path.set("assets/full.png","assets/full.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/full.png",value);
	DefaultAssetLibrary.path.set("assets/function.png","assets/function.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/function.png",value);
	DefaultAssetLibrary.path.set("assets/gopher.png","assets/gopher.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/gopher.png",value);
	DefaultAssetLibrary.path.set("assets/gophercolor16x16.png","assets/gophercolor16x16.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/gophercolor16x16.png",value);
	DefaultAssetLibrary.path.set("assets/gophercolor16x16flipped.png","assets/gophercolor16x16flipped.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/gophercolor16x16flipped.png",value);
	DefaultAssetLibrary.path.set("assets/oven.png","assets/oven.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/oven.png",value);
	DefaultAssetLibrary.path.set("assets/pick.png","assets/pick.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/pick.png",value);
	DefaultAssetLibrary.path.set("assets/shovel.png","assets/shovel.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/shovel.png",value);
	DefaultAssetLibrary.path.set("assets/smallpile.png","assets/smallpile.png");
	var value = Reflect.field(openfl.AssetType,"image".toUpperCase());
	DefaultAssetLibrary.type.set("assets/smallpile.png",value);
};
...
tardis.Go_utf8_RuneStart = function(gr,_bds,p_b) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,769,"Go_utf8_RuneStart");
	this._bds = _bds;
	this.p_b = p_b;
...
tardis.Go_haxegoruntime_StringCompare = function(gr,_bds,p_a,p_b) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,248,"Go_haxegoruntime_StringCompare");
	this._bds = _bds;
	this.p_a = p_a;
	this.p_b = p_b;
	tardis.Scheduler.push(gr,this);
...
tardis._Go.Go_main_main = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,10,"Go_main_main");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf16_DecodeRune = function(gr,_bds,p_r1,p_r2) {
	...
	this._t1 = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,306,"Go_utf16_DecodeRune");
	this._bds = _bds;
	this.p_r1 = p_r1;
	this.p_r2 = p_r2;
	tardis.Scheduler.push(gr,this);
...
tardis.Go_utf8_RuneCountInString = function(gr,_bds,p_s) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,759,"Go_utf8_RuneCountInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_Rune2Raw = function(gr,_bds,p_oneRune) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,241,"Go_haxegoruntime_Rune2Raw");
	this._bds = _bds;
...
tardis._Go.Go_main_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,243,"Go_main_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
	...
	,run: function() {
		while(true) {
			...
			case 1:
				...
				this._latestBlock = 1;
				tardis.Go.main_init_36_guard.store(true);
				new tardis._Go.Go_tardisgolib_init(this._goroutine,[]);
				this._Next = -1;
				return this;
			case -1:
				this._latestPH = 243;
...
tardis.Go_utf16_Decode = function(gr,_bds,p_s) {
	...
	this._t1 = null;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,355,"Go_utf16_Decode");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_DecodeLastRuneInString = function(gr,_bds,p_s) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,653,"Go_utf8_DecodeLastRuneInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_Raw2Runes = function(gr,_bds,p_s) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,183,"Go_haxegoruntime_Raw2Runes");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_StringsUTF8 = function(gr,_bds) {
	this._Next = 0;
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,849,"Go_tardisgolib_StringsUTF8");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_StringsUTF8"] = tardis.Go_tardisgolib_StringsUTF8;
$hxExpose(tardis.Go_tardisgolib_StringsUTF8, "Go_tardisgolib_StringsUTF8");
tardis.Go_tardisgolib_StringsUTF8.__name__ = ["tardis","Go_tardisgolib_StringsUTF8"];
tardis.Go_tardisgolib_StringsUTF8.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_StringsUTF8.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_StringsUTF8(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_StringsUTF8.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_StringsUTF8(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_StringsUTF8.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_StringsUTF8(gr,_bds);
}
tardis.Go_tardisgolib_StringsUTF8.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_StringsUTF8.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn0: function() {
	...
	,__class__: tardis.Go_tardisgolib_StringsUTF8
});
tardis._Go.Go_main_fireBooks = function(gr,_bds,p_x,p_y,p_state,p_cartLoad,p_out) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,99,"Go_main_fireBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
...
$hxClasses["tardis._Go.Go_main_fireBooks"] = tardis._Go.Go_main_fireBooks;
tardis._Go.Go_main_fireBooks.__name__ = ["tardis","_Go","Go_main_fireBooks"];
tardis._Go.Go_main_fireBooks.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_fireBooks.callFromHaxe = function(p_x,p_y,p_state,p_cartLoad,p_out) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_fireBooks(0,[],p_x,p_y,p_state,p_cartLoad,p_out).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_fireBooks.callFromRT = function(_gr,p_x,p_y,p_state,p_cartLoad,p_out) {
	var _sf = new tardis._Go.Go_main_fireBooks(_gr,[],p_x,p_y,p_state,p_cartLoad,p_out).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis._Go.Go_main_fireBooks.call = function(gr,_bds,p_x,p_y,p_state,p_cartLoad,p_out) {
	return new tardis._Go.Go_main_fireBooks(gr,_bds,p_x,p_y,p_state,p_cartLoad,p_out);
}
	...
	,run: function() {
		while(true) {
			...
			case 0:
				...
				this.p_state.store(2);
				this._latestPH = 101;
				new tardis._Go.Go_main_loop(this._goroutine,[],this.p_cartLoad);
				this._Next = -1;
				return this;
			case -1:
				this._latestPH = 101;
			...
			case -2:
				this._latestPH = 102;
				this._latestBlock = -2;
				if(!this.p_out.hasSpace()) return this;
				this.p_out.send(this.p_cartLoad);
				this._incomplete = false;
				tardis.Scheduler.pop(this._goroutine);
				return this;
			default:
...
tardis._Go.Go_utf8_decodeRuneInternal = function(gr,_bds,p_p) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,422,"Go_utf8_decodeRuneInternal");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_Valid = function(gr,_bds,p_p) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,772,"Go_utf8_Valid");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_tardisgolib_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,779,"Go_tardisgolib_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis._Go.Go_tardisgolib_init"] = tardis._Go.Go_tardisgolib_init;
tardis._Go.Go_tardisgolib_init.__name__ = ["tardis","_Go","Go_tardisgolib_init"];
tardis._Go.Go_tardisgolib_init.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_tardisgolib_init.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_tardisgolib_init(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_tardisgolib_init.callFromRT = function(_gr) {
	var _sf = new tardis._Go.Go_tardisgolib_init(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis._Go.Go_tardisgolib_init.call = function(gr,_bds) {
	return new tardis._Go.Go_tardisgolib_init(gr,_bds);
}
...
tardis._Go.Go_tardisgolib_init.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn1: function() {
		tardis.Go.tardisgolib_init_36_guard.store(true);
		this._Next = 2;
	}
	,SubFn0: function() {
		var _t0;
		_t0 = tardis.Go.tardisgolib_init_36_guard.ref();
		this._Next = _t0?2:1;
	}
	,run: function() {
		while(true) {
...
tardis.Go_main_StartGophers = function(gr,_bds) {
	this._Next = 0;
	this._Phi = 0;
	this._t34 = false;
	this._t33 = 0;
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,32,"Go_main_StartGophers");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_main_StartGophers"] = tardis.Go_main_StartGophers;
$hxExpose(tardis.Go_main_StartGophers, "Go_main_StartGophers");
tardis.Go_main_StartGophers.__name__ = ["tardis","Go_main_StartGophers"];
tardis.Go_main_StartGophers.__interfaces__ = [tardis.StackFrame];
tardis.Go_main_StartGophers.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_main_StartGophers(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis.Go_main_StartGophers.callFromRT = function(_gr) {
	var _sf = new tardis.Go_main_StartGophers(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis.Go_main_StartGophers.call = function(gr,_bds) {
	return new tardis.Go_main_StartGophers(gr,_bds);
}
tardis.Go_main_StartGophers.__super__ = tardis.StackFrameBasis;
tardis.Go_main_StartGophers.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn4: function() {
		var _t34;
		this._latestPH = 33;
		_t34 = this._t33 < 4;
	...
	,SubFn3: function() {
		...
		var _t31;
		this._latestPH = 39;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t14 = tardis.Go.main_ovens.addr(this._t33);
		_t15 = new tardis.Channel(0);
		_t14.store(_t15);
		_t16 = tardis.Go.main_ovens.ref();
		this._latestPH = 40;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t17 = _t16[this._t33];
		new tardis._Go.Go_main_fire(tardis.Scheduler.makeGoroutine(),[],_t17);
		this._latestPH = 43;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t18 = tardis.Go.main_Sprite1X.addr(this._t33);
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t19 = tardis.Go.main_Sprite1Y.addr(this._t33);
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t20 = tardis.Go.main_Sprite1state.addr(this._t33);
		_t21 = tardis.Go.main_bigpiles.ref();
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t22 = _t21[this._t33];
		_t23 = tardis.Go.main_smallpiles.ref();
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t24 = _t23[this._t33];
		new tardis._Go.Go_main_gopher(tardis.Scheduler.makeGoroutine(),[],_t18,_t19,_t20,_t22,_t24);
		this._latestPH = 44;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t25 = tardis.Go.main_Sprite2X.addr(this._t33);
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t26 = tardis.Go.main_Sprite2Y.addr(this._t33);
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t27 = tardis.Go.main_Sprite2state.addr(this._t33);
		_t28 = tardis.Go.main_smallpiles.ref();
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t29 = _t28[this._t33];
		_t30 = tardis.Go.main_ovens.ref();
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t31 = _t30[this._t33];
		new tardis._Go.Go_main_gopher(tardis.Scheduler.makeGoroutine(),[],_t25,_t26,_t27,_t29,_t31);
		this._t32 = this._t33 + 1;
		this._Next = 3;
	}
	,SubFn2: function() {
		var _t6;
		...
		var _t10;
		var _t12;
		_t6 = tardis.Go.main_bigpiles.ref();
		this._latestPH = 36;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t7 = _t6[this._t33];
		new tardis._Go.Go_main_fillbigpile(tardis.Scheduler.makeGoroutine(),[],_t7);
		this._latestPH = 37;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t8 = tardis.Go.main_smallpiles.addr(this._t33);
		_t9 = new tardis.Channel(0);
		_t8.store(_t9);
		_t10 = tardis.Go.main_smallpiles.ref();
		this._latestPH = 38;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		this._t11 = _t10[this._t33];
		_t12 = this._t33 + 1;
		this._t13 = tardis.Force.intDiv(10,_t12,0);
	}
	,SubFn1: function() {
		var _t0;
		var _t1;
		...
		this._latestPH = 34;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		_t0 = tardis.Go.main_bigpiles.addr(this._t33);
		_t1 = new tardis.Channel(0);
		_t0.store(_t1);
		_t2 = tardis.Go.main_bigpiles.ref();
		this._latestPH = 35;
		if(this._t33 < 0 || this._t33 >= 4) tardis.Scheduler.ioor();
		this._t3 = _t2[this._t33];
		_t4 = this._t33 + 1;
		this._t5 = _t4;
	}
	,SubFn0: function() {
	...
	,run: function() {
		while(true) {
			...
			case -1:
				this._latestPH = 35;
				this._latestBlock = -1;
				if(!this._t3.hasSpace()) return this;
				this._t3.send(this._t5);
				this.SubFn2();
				this._latestPH = 38;
				this._Next = -2;
				return this;
			case -2:
				this._latestPH = 38;
				this._latestBlock = -2;
				if(!this._t11.hasSpace()) return this;
				this._t11.send(this._t13);
				this.SubFn3();
				this._Phi = 1;
				break;
			case 2:
			...
			case 3:
				...
				this._latestBlock = 3;
				this._latestPH = 33;
				this._t33 = this._Phi == 0?0:this._Phi == 1?this._t32:0;
				this.SubFn4();
				this._Phi = 3;
				break;
			default:
	...
	,__class__: tardis.Go_main_StartGophers
});
tardis.Go_utf16_EncodeRune = function(gr,_bds,p_r) {
	...
	this._t1 = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,316,"Go_utf16_EncodeRune");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_utf8_decodeRuneInStringInternal = function(gr,_bds,p_s) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,500,"Go_utf8_decodeRuneInStringInternal");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_FullRuneInString = function(gr,_bds,p_s) {
	...
	this._t3 = false;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,586,"Go_utf8_FullRuneInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_ValidRune = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,810,"Go_utf8_ValidRune");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Host = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,835,"Go_tardisgolib_Host");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_Host"] = tardis.Go_tardisgolib_Host;
$hxExpose(tardis.Go_tardisgolib_Host, "Go_tardisgolib_Host");
tardis.Go_tardisgolib_Host.__name__ = ["tardis","Go_tardisgolib_Host"];
tardis.Go_tardisgolib_Host.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_Host.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_Host(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_Host.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_Host(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_Host.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_Host(gr,_bds);
}
tardis.Go_tardisgolib_Host.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_Host.prototype = $extend(tardis.StackFrameBasis.prototype,{
	run: function() {
		while(true) {
			var _g = this;
			switch(_g._Next) {
	...
	,__class__: tardis.Go_tardisgolib_Host
});
tardis._Go.Go_main_fire = function(gr,_bds,p_oven) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,61,"Go_main_fire");
	this._bds = _bds;
	this.p_oven = p_oven;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis._Go.Go_main_fire"] = tardis._Go.Go_main_fire;
tardis._Go.Go_main_fire.__name__ = ["tardis","_Go","Go_main_fire"];
tardis._Go.Go_main_fire.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_fire.callFromHaxe = function(p_oven) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_fire(0,[],p_oven).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_fire.callFromRT = function(_gr,p_oven) {
	var _sf = new tardis._Go.Go_main_fire(_gr,[],p_oven).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis._Go.Go_main_fire.call = function(gr,_bds,p_oven) {
	return new tardis._Go.Go_main_fire(gr,_bds,p_oven);
}
	...
	,run: function() {
		while(true) {
			...
			case -1:
				this._latestPH = 63;
				this._latestBlock = -1;
				if(this.p_oven.hasNoContents()) return this;
				this.p_oven.receive(0).r0;
				this._Next = 1;
				break;
			default:
				tardis.Scheduler.bbi();
...
tardis._Go.Go_utf8_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,63,"Go_utf8_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_DecodeLastRune = function(gr,_bds,p_p) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,616,"Go_utf8_DecodeLastRune");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_UTF8toRunes = function(gr,_bds,p_s) {
	...
	this._t1 = null;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,167,"Go_haxegoruntime_UTF8toRunes");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Zilen = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,846,"Go_tardisgolib_Zilen");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_Zilen"] = tardis.Go_tardisgolib_Zilen;
$hxExpose(tardis.Go_tardisgolib_Zilen, "Go_tardisgolib_Zilen");
tardis.Go_tardisgolib_Zilen.__name__ = ["tardis","Go_tardisgolib_Zilen"];
tardis.Go_tardisgolib_Zilen.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_Zilen.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_Zilen(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_Zilen.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_Zilen(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_Zilen.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_Zilen(gr,_bds);
}
tardis.Go_tardisgolib_Zilen.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_Zilen.prototype = $extend(tardis.StackFrameBasis.prototype,{
	run: function() {
		while(true) {
			var _g = this;
			switch(_g._Next) {
	...
	,__class__: tardis.Go_tardisgolib_Zilen
});
tardis._Go.Go_main_pushBooks = function(gr,_bds,p_x,p_y,p_state,p_cartLoad) {
	...
	this._t1 = false;
	this._t0 = 0.0;
	tardis.StackFrameBasis.call(this,gr,84,"Go_main_pushBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
$hxClasses["tardis._Go.Go_main_pushBooks"] = tardis._Go.Go_main_pushBooks;
tardis._Go.Go_main_pushBooks.__name__ = ["tardis","_Go","Go_main_pushBooks"];
tardis._Go.Go_main_pushBooks.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_pushBooks.callFromHaxe = function(p_x,p_y,p_state,p_cartLoad) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_pushBooks(0,[],p_x,p_y,p_state,p_cartLoad).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_pushBooks.callFromRT = function(_gr,p_x,p_y,p_state,p_cartLoad) {
	var _sf = new tardis._Go.Go_main_pushBooks(_gr,[],p_x,p_y,p_state,p_cartLoad).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis._Go.Go_main_pushBooks.call = function(gr,_bds,p_x,p_y,p_state,p_cartLoad) {
	return new tardis._Go.Go_main_pushBooks(gr,_bds,p_x,p_y,p_state,p_cartLoad);
}
...
tardis._Go.Go_main_pushBooks.prototype = $extend(tardis.StackFrameBasis.prototype,{
	...
	,SubFn6: function() {
		var _t12;
		this._latestPH = 90;
		_t12 = js.Boot.__cast(this._t11 , Float);
		this.p_y.store(_t12);
		this._Next = 5;
	}
	,SubFn5: function() {
	...
	,run: function() {
		while(true) {
			...
			case 5:
				...
				this._latestBlock = 5;
				this._latestPH = 92;
				new tardis.Go_tardisgolib_Gosched(this._goroutine,[]);
				this._Next = -1;
				return this;
			case -1:
				this._latestPH = 92;
...
tardis.Go_utf8_DecodeRuneInString = function(gr,_bds,p_s) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,606,"Go_utf8_DecodeRuneInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_FullRune = function(gr,_bds,p_p) {
	...
	this._t3 = false;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,580,"Go_utf8_FullRune");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_UTF16toRunes = function(gr,_bds,p_s) {
	this._Next = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,163,"Go_haxegoruntime_UTF16toRunes");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_CPos = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,842,"Go_tardisgolib_CPos");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_CPos"] = tardis.Go_tardisgolib_CPos;
$hxExpose(tardis.Go_tardisgolib_CPos, "Go_tardisgolib_CPos");
tardis.Go_tardisgolib_CPos.__name__ = ["tardis","Go_tardisgolib_CPos"];
tardis.Go_tardisgolib_CPos.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_CPos.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_CPos(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_CPos.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_CPos(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_CPos.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_CPos(gr,_bds);
}
tardis.Go_tardisgolib_CPos.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_CPos.prototype = $extend(tardis.StackFrameBasis.prototype,{
	run: function() {
		while(true) {
			var _g = this;
			switch(_g._Next) {
	...
	,__class__: tardis.Go_tardisgolib_CPos
});
tardis._Go.Go_main_pickBooks = function(gr,_bds,p_x,p_y,p_state,p_in) {
	this._Next = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,77,"Go_main_pickBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
$hxClasses["tardis._Go.Go_main_pickBooks"] = tardis._Go.Go_main_pickBooks;
tardis._Go.Go_main_pickBooks.__name__ = ["tardis","_Go","Go_main_pickBooks"];
tardis._Go.Go_main_pickBooks.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_pickBooks.callFromHaxe = function(p_x,p_y,p_state,p_in) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_pickBooks(0,[],p_x,p_y,p_state,p_in).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis._Go.Go_main_pickBooks.callFromRT = function(_gr,p_x,p_y,p_state,p_in) {
	var _sf = new tardis._Go.Go_main_pickBooks(_gr,[],p_x,p_y,p_state,p_in).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis._Go.Go_main_pickBooks.call = function(gr,_bds,p_x,p_y,p_state,p_in) {
	return new tardis._Go.Go_main_pickBooks(gr,_bds,p_x,p_y,p_state,p_in);
}
	...
	,run: function() {
		while(true) {
			...
			case -1:
				this._latestPH = 80;
				this._latestBlock = -1;
				if(this.p_in.hasNoContents()) return this;
				this._t0 = this.p_in.receive(0).r0;
				this._latestPH = 81;
				new tardis._Go.Go_main_loop(this._goroutine,[],this._t0);
				this._Next = -2;
				return this;
			case -2:
				this._latestPH = 81;
...
tardis._Go.Go_utf16_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,79,"Go_utf16_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_ValidString = function(gr,_bds,p_s) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,792,"Go_utf8_ValidString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_HAXE = function(gr,_bds,p_code) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,832,"Go_tardisgolib_HAXE");
	this._bds = _bds;
	this.p_code = p_code;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_HAXE"] = tardis.Go_tardisgolib_HAXE;
$hxExpose(tardis.Go_tardisgolib_HAXE, "Go_tardisgolib_HAXE");
tardis.Go_tardisgolib_HAXE.__name__ = ["tardis","Go_tardisgolib_HAXE"];
tardis.Go_tardisgolib_HAXE.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_HAXE.callFromHaxe = function(p_code) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_HAXE(0,[],p_code).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_HAXE.callFromRT = function(_gr,p_code) {
	var _sf = new tardis.Go_tardisgolib_HAXE(_gr,[],p_code).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_HAXE.call = function(gr,_bds,p_code) {
	return new tardis.Go_tardisgolib_HAXE(gr,_bds,p_code);
}
tardis.Go_tardisgolib_HAXE.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_HAXE.prototype = $extend(tardis.StackFrameBasis.prototype,{
	run: function() {
		while(true) {
			var _g = this;
			switch(_g._Next) {
	...
	,__class__: tardis.Go_tardisgolib_HAXE
});
tardis._Go.Go_main_fillbigpile = function(gr,_bds,p_bigpile) {
	this._Next = 0;
	this._t8 = null;
	this._t7 = false;
	this._t6 = false;
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,48,"Go_main_fillbigpile");
	this._bds = _bds;
	this.p_bigpile = p_bigpile;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis._Go.Go_main_fillbigpile"] = tardis._Go.Go_main_fillbigpile;
tardis._Go.Go_main_fillbigpile.__name__ = ["tardis","_Go","Go_main_fillbigpile"];
tardis._Go.Go_main_fillbigpile.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_fillbigpile.callFromHaxe = function(p_bigpile) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_fillbigpile(0,[],p_bigpile).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_fillbigpile.callFromRT = function(_gr,p_bigpile) {
	var _sf = new tardis._Go.Go_main_fillbigpile(_gr,[],p_bigpile).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis._Go.Go_main_fillbigpile.call = function(gr,_bds,p_bigpile) {
	return new tardis._Go.Go_main_fillbigpile(gr,_bds,p_bigpile);
}
...
tardis._Go.Go_main_fillbigpile.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn7: function() {
		this._t8 = new tardis.Interface(0,"blocking select matched no case");
	}
	,SubFn6: function() {
		var _t7;
		_t7 = this._t1 == 5;
	...
	,run: function() {
		while(true) {
			...
			case -1:
				this._latestPH = 50;
				this._latestBlock = -1;
				this._t0 = { r0 : 0, r1 : false};
				this._t0.r0 = -1;
				var _states = new Array();
				var _rnd = Std.random(6);
				_states[0] = this.p_bigpile.hasSpace();
				_states[1] = this.p_bigpile.hasSpace();
				_states[2] = this.p_bigpile.hasSpace();
				_states[3] = this.p_bigpile.hasSpace();
				_states[4] = this.p_bigpile.hasSpace();
				_states[5] = this.p_bigpile.hasSpace();
				var _g1 = 0;
				while(_g1 < 6) {
					var _s = _g1++;
					var _i = (_s + _rnd) % 6;
				...
				switch(_g1._t0.r0) {
				case 0:
					this.p_bigpile.send(1);
					break;
				case 1:
					this.p_bigpile.send(2);
					break;
				case 2:
					this.p_bigpile.send(3);
					break;
				case 3:
					this.p_bigpile.send(8);
					break;
				case 4:
					this.p_bigpile.send(9);
					break;
				case 5:
					this.p_bigpile.send(10);
					break;
				}
				if(this._t0.r0 == -1) return this;
				this.SubFn1();
				break;
			case 2:
				this._latestPH = 50;
			...
			case 7:
				...
				this._latestBlock = 7;
				this._t8 = new tardis.Interface(0,"blocking select matched no case");
				tardis.Scheduler.panic(this._goroutine,this._t8);
				this._Next = -2;
				return this;
			case -2:
				this._latestPH = 50;
...
tardis.Go_utf8_EncodeRune = function(gr,_bds,p_p,p_r) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,707,"Go_utf8_EncodeRune");
	this._bds = _bds;
	this.p_p = p_p;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
...
tardis.Go_haxegoruntime_RunesToUTF8 = function(gr,_bds,p_r) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,207,"Go_haxegoruntime_RunesToUTF8");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_haxegoruntime_init_36_1 = function(gr,_bds) {
	this._Next = 0;
	this._t11 = null;
	tardis.StackFrameBasis.call(this,gr,142,"Go_haxegoruntime_init_36_1");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Gosched = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,859,"Go_tardisgolib_Gosched");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_Gosched"] = tardis.Go_tardisgolib_Gosched;
$hxExpose(tardis.Go_tardisgolib_Gosched, "Go_tardisgolib_Gosched");
tardis.Go_tardisgolib_Gosched.__name__ = ["tardis","Go_tardisgolib_Gosched"];
tardis.Go_tardisgolib_Gosched.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_Gosched.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_Gosched(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis.Go_tardisgolib_Gosched.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_Gosched(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis.Go_tardisgolib_Gosched.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_Gosched(gr,_bds);
}
...
tardis._Go.Go_main_loop = function(gr,_bds,p_n) {
	this._Next = 0;
	this._Phi = 0;
	this._t3 = false;
	this._t2 = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,120,"Go_main_loop");
	this._bds = _bds;
	this.p_n = p_n;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis._Go.Go_main_loop"] = tardis._Go.Go_main_loop;
tardis._Go.Go_main_loop.__name__ = ["tardis","_Go","Go_main_loop"];
tardis._Go.Go_main_loop.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_loop.callFromHaxe = function(p_n) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_loop(0,[],p_n).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_loop.callFromRT = function(_gr,p_n) {
	var _sf = new tardis._Go.Go_main_loop(_gr,[],p_n).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis._Go.Go_main_loop.call = function(gr,_bds,p_n) {
	return new tardis._Go.Go_main_loop(gr,_bds,p_n);
}
tardis._Go.Go_main_loop.__super__ = tardis.StackFrameBasis;
tardis._Go.Go_main_loop.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn3: function() {
		var _t3;
		this._latestPH = 121;
		_t3 = this._t2 > 0;
	...
	,run: function() {
		while(true) {
			...
			case 3:
				...
				this._latestBlock = 3;
				this._latestPH = 120;
				this._t2 = this._Phi == 0?this.p_n:this._Phi == 1?this._t0:0;
				this.SubFn3();
				this._Phi = 3;
				break;
			default:
	...
	,__class__: tardis._Go.Go_main_loop
});
tardis.Go_utf16_IsSurrogate = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,299,"Go_utf16_IsSurrogate");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_RuneLen = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,687,"Go_utf8_RuneLen");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_RunesToUTF16 = function(gr,_bds,p_r) {
	this._Next = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,203,"Go_haxegoruntime_RunesToUTF16");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_StringsUTF16 = function(gr,_bds) {
	this._Next = 0;
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,852,"Go_tardisgolib_StringsUTF16");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_StringsUTF16"] = tardis.Go_tardisgolib_StringsUTF16;
$hxExpose(tardis.Go_tardisgolib_StringsUTF16, "Go_tardisgolib_StringsUTF16");
tardis.Go_tardisgolib_StringsUTF16.__name__ = ["tardis","Go_tardisgolib_StringsUTF16"];
tardis.Go_tardisgolib_StringsUTF16.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_StringsUTF16.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_StringsUTF16(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_StringsUTF16.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_StringsUTF16(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_StringsUTF16.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_StringsUTF16(gr,_bds);
}
tardis.Go_tardisgolib_StringsUTF16.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_StringsUTF16.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn0: function() {
	...
	,__class__: tardis.Go_tardisgolib_StringsUTF16
});
tardis._Go.Go_main_moreBooks = function(gr,_bds,p_x,p_y,p_state) {
	...
	this._t1 = 0.0;
	this._t0 = 0.0;
	tardis.StackFrameBasis.call(this,gr,104,"Go_main_moreBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
$hxClasses["tardis._Go.Go_main_moreBooks"] = tardis._Go.Go_main_moreBooks;
tardis._Go.Go_main_moreBooks.__name__ = ["tardis","_Go","Go_main_moreBooks"];
tardis._Go.Go_main_moreBooks.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_moreBooks.callFromHaxe = function(p_x,p_y,p_state) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_moreBooks(0,[],p_x,p_y,p_state).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_moreBooks.callFromRT = function(_gr,p_x,p_y,p_state) {
	var _sf = new tardis._Go.Go_main_moreBooks(_gr,[],p_x,p_y,p_state).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
}
tardis._Go.Go_main_moreBooks.call = function(gr,_bds,p_x,p_y,p_state) {
	return new tardis._Go.Go_main_moreBooks(gr,_bds,p_x,p_y,p_state);
}
...
tardis._Go.Go_main_moreBooks.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn8: function() {
		var _t10;
		this._latestPH = 114;
		_t10 = js.Boot.__cast(this._t9 , Float);
		this.p_y.store(_t10);
		this._Next = 7;
	}
	,SubFn7: function() {
...
tardis.Go_utf8_DecodeRune = function(gr,_bds,p_p) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,596,"Go_utf8_DecodeRune");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_haxegoruntime_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,598,"Go_haxegoruntime_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Platform = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,839,"Go_tardisgolib_Platform");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_Platform"] = tardis.Go_tardisgolib_Platform;
$hxExpose(tardis.Go_tardisgolib_Platform, "Go_tardisgolib_Platform");
tardis.Go_tardisgolib_Platform.__name__ = ["tardis","Go_tardisgolib_Platform"];
tardis.Go_tardisgolib_Platform.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_Platform.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_Platform(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_Platform.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_Platform(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_Platform.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_Platform(gr,_bds);
}
tardis.Go_tardisgolib_Platform.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_Platform.prototype = $extend(tardis.StackFrameBasis.prototype,{
	run: function() {
		while(true) {
			var _g = this;
			switch(_g._Next) {
	...
	,__class__: tardis.Go_tardisgolib_Platform
});
tardis._Go.Go_main_gopher = function(gr,_bds,p_x,p_y,p_state,p_in,p_out) {
	this._Next = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,68,"Go_main_gopher");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
$hxClasses["tardis._Go.Go_main_gopher"] = tardis._Go.Go_main_gopher;
tardis._Go.Go_main_gopher.__name__ = ["tardis","_Go","Go_main_gopher"];
tardis._Go.Go_main_gopher.__interfaces__ = [tardis.StackFrame];
tardis._Go.Go_main_gopher.callFromHaxe = function(p_x,p_y,p_state,p_in,p_out) {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_gopher(0,[],p_x,p_y,p_state,p_in,p_out).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_gopher.callFromRT = function(_gr,p_x,p_y,p_state,p_in,p_out) {
	var _sf = new tardis._Go.Go_main_gopher(_gr,[],p_x,p_y,p_state,p_in,p_out).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
	...
	,run: function() {
		while(true) {
			...
			case 1:
				...
				this._latestBlock = 1;
				this._latestPH = 70;
				this._SF1 = new tardis._Go.Go_main_pickBooks(this._goroutine,[],this.p_x,this.p_y,this.p_state,this.p_in);
				this._Next = -1;
				return this;
			case -1:
				this._latestPH = 70;
				...
				this._t0 = this._SF1.res();
				this._latestPH = 71;
				new tardis._Go.Go_main_pushBooks(this._goroutine,[],this.p_x,this.p_y,this.p_state,this._t0);
				this._Next = -2;
				return this;
			case -2:
				this._latestPH = 71;
				this._latestBlock = -2;
				this._latestPH = 72;
				new tardis._Go.Go_main_fireBooks(this._goroutine,[],this.p_x,this.p_y,this.p_state,this._t0,this.p_out);
				this._Next = -3;
				return this;
			case -3:
				this._latestPH = 72;
				this._latestBlock = -3;
				this._latestPH = 73;
				new tardis._Go.Go_main_moreBooks(this._goroutine,[],this.p_x,this.p_y,this.p_state);
				this._Next = -4;
				return this;
			case -4:
				this._latestPH = 73;
...
tardis.Go_utf16_Encode = function(gr,_bds,p_s) {
	...
	this._t1 = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,325,"Go_utf16_Encode");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_RuneCount = function(gr,_bds,p_p) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,744,"Go_utf8_RuneCount");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_Runes2Raw = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,219,"Go_haxegoruntime_Runes2Raw");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_NumGoroutine = function(gr,_bds) {
	this._Next = 0;
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,862,"Go_tardisgolib_NumGoroutine");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
$hxClasses["tardis.Go_tardisgolib_NumGoroutine"] = tardis.Go_tardisgolib_NumGoroutine;
$hxExpose(tardis.Go_tardisgolib_NumGoroutine, "Go_tardisgolib_NumGoroutine");
tardis.Go_tardisgolib_NumGoroutine.__name__ = ["tardis","Go_tardisgolib_NumGoroutine"];
tardis.Go_tardisgolib_NumGoroutine.__interfaces__ = [tardis.StackFrame];
tardis.Go_tardisgolib_NumGoroutine.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis.Go_tardisgolib_NumGoroutine(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
	return _sf._res;
}
tardis.Go_tardisgolib_NumGoroutine.callFromRT = function(_gr) {
	var _sf = new tardis.Go_tardisgolib_NumGoroutine(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis.Go_tardisgolib_NumGoroutine.call = function(gr,_bds) {
	return new tardis.Go_tardisgolib_NumGoroutine(gr,_bds);
}
tardis.Go_tardisgolib_NumGoroutine.__super__ = tardis.StackFrameBasis;
tardis.Go_tardisgolib_NumGoroutine.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn0: function() {
	...
	,__class__: tardis.Go_tardisgolib_NumGoroutine
});
tardis.Go = function() { }
...
tardis.Go.CPos = function(pos) {
	...
	if(pos > 820) return prefix + "/Users/elliott/go/src/github.com/tardisgo/tardisgo/tardisgolib/tardisgolib.go:" + Std.string(pos - 820); else if(pos > 377) return prefix + "/usr/local/go/src/pkg/unicode/utf8/utf8.go:" + Std.string(pos - 377); else if(pos > 269) return prefix + "/usr/local/go/src/pkg/unicode/utf16/utf16.go:" + Std.string(pos - 269); else if(pos > 125) return prefix + "/Users/elliott/go/src/github.com/tardisgo/tardisgo/haxe/haxegoruntime/haxegoruntime.go:" + Std.string(pos - 125); else if(pos > 0) return prefix + "gophers.go:" + Std.string(pos); else return "(invalid pogo.PosHash:" + Std.string(pos) + ")";
}
...
tardis.Go.main_Shovel = 2;
tardis.Go.main_Pick = 0;
tardis.Go.main_Full = 1;
tardis.Go.main_Empty = 3;
...
tardis.Go.tardisgolib_init_36_guard = new tardis.Pointer(false);
tardis.Go.main_Sprite1X = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
...
tardis.Go.main_Sprite2Y = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
...
tardis.Go.main_smallpiles = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
		while(_g < 4) {
			var _vi = _g++;
			_v[_vi] = new tardis.Channel(1);
		}
	}
	$r = _v;
	return $r;
}(this)));
tardis.Go.main_Sprite1state = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
...
tardis.Go.main_Sprite2state = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
...
tardis.Go.main_Sprite1Y = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
...
tardis.Go.main_Sprite2X = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
...
tardis.Go.main_bigpiles = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
...
tardis.Go.main_ovens = new tardis.Pointer((function($this) {
	var $r;
	var _v = new Array();
	{
		var _g = 0;
