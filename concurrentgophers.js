...
var Main = function() {
	...
	this.whatToDo.set_y(140);
	this.whatToDo.set_width(200);
	this.whatToDo.set_height(200);
	this.whatToDo.set_text("Both animated gophers are \nrunning the code on the right.\nThe 2 logos show where they\neach are in that code now.\nThis code is running live,\ntargeting: " + tardis.Go.Platform());
	this.whatToDo.set_textColor(32768);
	this.addChild(this.whatToDo);
	this.bigpile = new flash.display.Sprite();
	this.bigpile.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/bigpile.png")));
	this.bigpile.set_x(10);
	this.bigpile.set_y(20);
	this.addChild(this.bigpile);
	this.oven = new flash.display.Sprite();
	this.oven.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/oven.png")));
	this.oven.set_x(690);
	this.oven.set_y(0);
	this.addChild(this.oven);
	this.Books = new flash.display.Sprite();
	this.Books.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/smallpile.png")));
	this.Books.set_x(this.bx);
	this.Books.set_y(this.by);
	this.addChild(this.Books);
	this.Sprite1 = new flash.display.Sprite();
	this.Sprite1.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
	this.Sprite1.set_x(this.s1x);
	this.Sprite1.set_y(this.s1y);
	this.addChild(this.Sprite1);
	this.Sprite2 = new flash.display.Sprite();
	this.Sprite2.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
	this.Sprite2.set_x(this.s2x);
	this.Sprite2.set_y(this.s2y);
...
Main.prototype = $extend(flash.display.Sprite.prototype,{
	goTimerEvent: function(e) {
		...
		if(tardis.Go.main_smallpile.ref().hasContents() != this.bookslaststatus) {
			this.bookslaststatus = tardis.Go.main_smallpile.ref().hasContents();
			this.Books.removeChildAt(0);
			if(tardis.Go.main_smallpile.ref().hasContents() == true) this.Books.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/smallpile.png"))); else this.Books.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/emptypile.png")));
		}
		if((tardis.Go.main_Sprite1state.ref() | 0) != this.s1laststatus) {
			this.Sprite1.removeChildAt(0);
			this.s1laststatus = tardis.Go.main_Sprite1state.ref() | 0;
			this.Logo1.set_y(140 + 15 * this.s1laststatus);
			if(this.s1laststatus == tardis.Go.main_Pick) this.Sprite1.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
			if(this.s1laststatus == tardis.Go.main_Full) this.Sprite1.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/full.png")));
			if(this.s1laststatus == tardis.Go.main_Shovel) this.Sprite1.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/shovel.png")));
			if(this.s1laststatus == tardis.Go.main_Empty) this.Sprite1.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/empty.png")));
		}
		this.Sprite1.set_x(this.s1x + tardis.Go.main_Sprite1X.ref());
		this.Sprite1.set_y(this.s1y + tardis.Go.main_Sprite1Y.ref());
		if((tardis.Go.main_Sprite2state.ref() | 0) != this.s2laststatus) {
			this.Sprite2.removeChildAt(0);
			this.s2laststatus = tardis.Go.main_Sprite2state.ref() | 0;
			this.Logo2.set_y(140 + 15 * this.s2laststatus);
			if(this.s2laststatus == tardis.Go.main_Pick) this.Sprite2.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/pick.png")));
			if(this.s2laststatus == tardis.Go.main_Full) this.Sprite2.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/full.png")));
			if(this.s2laststatus == tardis.Go.main_Shovel) this.Sprite2.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/shovel.png")));
			if(this.s2laststatus == tardis.Go.main_Empty) this.Sprite2.addChild(new flash.display.Bitmap(openfl.Assets.getBitmapData("assets/empty.png")));
		}
		this.Sprite2.set_x(this.s2x + tardis.Go.main_Sprite2X.ref());
		this.Sprite2.set_y(this.s2y + tardis.Go.main_Sprite2Y.ref());
	}
	,__class__: Main
});
...
tardis._Go.Go_utf8_decodeRuneInternal = function(gr,_bds,p_p) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,407,"Go_utf8_decodeRuneInternal");
	this._bds = _bds;
	this.p_p = p_p;
...
tardis.Go_utf8_Valid = function(gr,_bds,p_p) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,757,"Go_utf8_Valid");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_tardisgolib_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,764,"Go_tardisgolib_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_main_StartGophers = function(gr,_bds) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,22,"Go_main_StartGophers");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_main_StartGophers.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn2: function() {
		...
		var _t7;
		var _t8;
		_t4 = tardis.Go.main_bigpile.ref();
		_t5 = tardis.Go.main_smallpile.ref();
		this._latestPH = 28;
		new tardis._Go.Go_main_gopher(tardis.Scheduler.makeGoroutine(),[],tardis.Go.main_Sprite1X,tardis.Go.main_Sprite1Y,tardis.Go.main_Sprite1state,_t4,_t5);
		this._latestPH = 29;
		_t6 = new tardis.Channel(0);
		tardis.Go.main_oven.store(_t6);
		_t7 = tardis.Go.main_smallpile.ref();
		_t8 = tardis.Go.main_oven.ref();
		this._latestPH = 30;
		new tardis._Go.Go_main_gopher(tardis.Scheduler.makeGoroutine(),[],tardis.Go.main_Sprite2X,tardis.Go.main_Sprite2Y,tardis.Go.main_Sprite2state,_t7,_t8);
		this._latestPH = 31;
		new tardis._Go.Go_main_fire(tardis.Scheduler.makeGoroutine(),[]);
	}
	,SubFn1: function() {
		var _t2;
		this._latestPH = 25;
		new tardis._Go.Go_main_fillbigpile(tardis.Scheduler.makeGoroutine(),[]);
		this._latestPH = 26;
		_t2 = new tardis.Channel(0);
		tardis.Go.main_smallpile.store(_t2);
		this._t3 = tardis.Go.main_smallpile.ref();
	}
	,SubFn0: function() {
		var _t0;
		this._latestPH = 23;
		...
		this._t1 = tardis.Go.main_bigpile.ref();
	}
	,run: function() {
		while(true) {
			var _g = this;
			...
			case -1:
				this._latestPH = 24;
				this._latestBlock = -1;
				if(!this._t1.hasSpace()) return this;
				this._t1.send(1);
				this.SubFn1();
				this._latestPH = 27;
				this._Next = -2;
...
tardis.Go_utf8_DecodeRune = function(gr,_bds,p_p) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,581,"Go_utf8_DecodeRune");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_utf8_decodeRuneInStringInternal = function(gr,_bds,p_s) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,485,"Go_utf8_decodeRuneInStringInternal");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_haxegoruntime_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,553,"Go_haxegoruntime_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Platform = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,824,"Go_tardisgolib_Platform");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_gopher = function(gr,_bds,p_x,p_y,p_state,p_in,p_out) {
	this._Next = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,53,"Go_main_gopher");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
...
tardis.Go_utf16_Encode = function(gr,_bds,p_s) {
	...
	this._t1 = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,310,"Go_utf16_Encode");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_RuneCount = function(gr,_bds,p_p) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,729,"Go_utf8_RuneCount");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_Runes2Raw = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,204,"Go_haxegoruntime_Runes2Raw");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_NumGoroutine = function(gr,_bds) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,847,"Go_tardisgolib_NumGoroutine");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_RuneStart = function(gr,_bds,p_b) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,754,"Go_utf8_RuneStart");
	this._bds = _bds;
	this.p_b = p_b;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_utf8_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,754,"Go_utf8_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_StringCompare = function(gr,_bds,p_a,p_b) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,233,"Go_haxegoruntime_StringCompare");
	this._bds = _bds;
	this.p_a = p_a;
	this.p_b = p_b;
	tardis.Scheduler.push(gr,this);
...
tardis._Go.Go_main_main = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,8,"Go_main_main");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf16_DecodeRune = function(gr,_bds,p_r1,p_r2) {
	...
	this._t1 = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,291,"Go_utf16_DecodeRune");
	this._bds = _bds;
	this.p_r1 = p_r1;
	this.p_r2 = p_r2;
	tardis.Scheduler.push(gr,this);
...
tardis.Go_utf8_RuneCountInString = function(gr,_bds,p_s) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,744,"Go_utf8_RuneCountInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_haxegoruntime_init_36_1 = function(gr,_bds) {
	this._Next = 0;
	this._t11 = null;
	tardis.StackFrameBasis.call(this,gr,127,"Go_haxegoruntime_init_36_1");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_Rune2Raw = function(gr,_bds,p_oneRune) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,226,"Go_haxegoruntime_Rune2Raw");
	this._bds = _bds;
...
tardis._Go.Go_main_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,228,"Go_main_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf16_Decode = function(gr,_bds,p_s) {
	...
	this._t1 = null;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,340,"Go_utf16_Decode");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_ValidString = function(gr,_bds,p_s) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,777,"Go_utf8_ValidString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_HAXE = function(gr,_bds,p_code) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,817,"Go_tardisgolib_HAXE");
	this._bds = _bds;
	this.p_code = p_code;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_fillbigpile = function(gr,_bds) {
	...
	this._t1 = null;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,34,"Go_main_fillbigpile");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_fillbigpile.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_fillbigpile(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_fillbigpile.callFromRT = function(_gr) {
	var _sf = new tardis._Go.Go_main_fillbigpile(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis._Go.Go_main_fillbigpile.prototype = $extend(tardis.StackFrameBasis.prototype,{
	SubFn8: function() {
		this._t14 = new tardis.Interface(0,"blocking select matched no case");
	}
	,SubFn7: function() {
		var _t13;
		_t13 = this._t7 == 5;
	...
	,SubFn2: function() {
		var _t8;
		this._t7 = this._t6.r0;
		_t8 = this._t7 == 0;
		this._Next = _t8?1:2;
	}
	,SubFn1: function() {
		this._t0 = tardis.Go.main_bigpile.ref();
		this._t1 = tardis.Go.main_bigpile.ref();
		this._t2 = tardis.Go.main_bigpile.ref();
		this._t3 = tardis.Go.main_bigpile.ref();
		this._t4 = tardis.Go.main_bigpile.ref();
		this._t5 = tardis.Go.main_bigpile.ref();
	}
	,SubFn0: function() {
		this._Next = 1;
	}
	,run: function() {
		while(true) {
			...
			case -1:
				this._latestPH = 36;
				this._latestBlock = -1;
				this._t6 = { r0 : 0, r1 : false};
				this._t6.r0 = -1;
				var _states = new Array();
				var _rnd = Std.random(6);
				_states[0] = this._t0.hasSpace();
				_states[1] = this._t1.hasSpace();
				_states[2] = this._t2.hasSpace();
				_states[3] = this._t3.hasSpace();
				_states[4] = this._t4.hasSpace();
				_states[5] = this._t5.hasSpace();
				var _g1 = 0;
				while(_g1 < 6) {
					var _s = _g1++;
					var _i = (_s + _rnd) % 6;
			...
			case 7:
				...
				this._latestBlock = 7;
				this._t14 = new tardis.Interface(0,"blocking select matched no case");
				tardis.Scheduler.panic(this._goroutine,this._t14);
				this._Next = -2;
				return this;
			case -2:
				this._latestPH = 36;
...
tardis.Go_utf16_EncodeRune = function(gr,_bds,p_r) {
	...
	this._t1 = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,301,"Go_utf16_EncodeRune");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_EncodeRune = function(gr,_bds,p_p,p_r) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,692,"Go_utf8_EncodeRune");
	this._bds = _bds;
	this.p_p = p_p;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
...
tardis.Go_haxegoruntime_RunesToUTF8 = function(gr,_bds,p_r) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,192,"Go_haxegoruntime_RunesToUTF8");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Gosched = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,844,"Go_tardisgolib_Gosched");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_loop = function(gr,_bds,p_n) {
	...
	this._t2 = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,105,"Go_main_loop");
	this._bds = _bds;
	this.p_n = p_n;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf16_IsSurrogate = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,284,"Go_utf16_IsSurrogate");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_RuneLen = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,672,"Go_utf8_RuneLen");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_RunesToUTF16 = function(gr,_bds,p_r) {
	this._Next = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,188,"Go_haxegoruntime_RunesToUTF16");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_StringsUTF16 = function(gr,_bds) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,837,"Go_tardisgolib_StringsUTF16");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_moreBooks = function(gr,_bds,p_x,p_y,p_state) {
	...
	this._t1 = 0.0;
	this._t0 = 0.0;
	tardis.StackFrameBasis.call(this,gr,89,"Go_main_moreBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
tardis.Go_utf8_ValidRune = function(gr,_bds,p_r) {
	...
	this._t1 = false;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,795,"Go_utf8_ValidRune");
	this._bds = _bds;
	this.p_r = p_r;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_FullRuneInString = function(gr,_bds,p_s) {
	...
	this._t3 = false;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,571,"Go_utf8_FullRuneInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Host = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,820,"Go_tardisgolib_Host");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_fire = function(gr,_bds) {
	this._Next = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,47,"Go_main_fire");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_fire.callFromHaxe = function() {
	if(!tardis.Go.doneInit) tardis.Go.init();
	var _sf = new tardis._Go.Go_main_fire(0,[]).run();
	while(_sf._incomplete) tardis.Scheduler.runAll();
}
tardis._Go.Go_main_fire.callFromRT = function(_gr) {
	var _sf = new tardis._Go.Go_main_fire(_gr,[]).run();
	while(_sf._incomplete) if(tardis.Scheduler.grStacks[_gr].first() == null) throw "Panic:" + Std.string(tardis.Scheduler.grPanicMsg) + "\nScheduler: null stack entry for goroutine " + _gr + "\n" + tardis.Scheduler.stackDump(); else {
		tardis.Scheduler.currentGR = _gr;
		tardis.Scheduler.grStacks[_gr].first().run();
	}
...
tardis._Go.Go_main_fire.prototype = $extend(tardis.StackFrameBasis.prototype,{
	...
	,SubFn1: function() {
		this._t0 = tardis.Go.main_oven.ref();
	}
	,SubFn0: function() {
		this._Next = 1;
	}
	,run: function() {
		while(true) {
			...
			case -1:
				this._latestPH = 49;
				this._latestBlock = -1;
				if(this._t0.hasNoContents()) return this;
				this._t0.receive(0).r0;
				this._Next = 1;
				break;
			default:
				tardis.Scheduler.bbi();
...
tardis.Go_utf8_DecodeLastRune = function(gr,_bds,p_p) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,601,"Go_utf8_DecodeLastRune");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_UTF8toRunes = function(gr,_bds,p_s) {
	...
	this._t1 = null;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,152,"Go_haxegoruntime_UTF8toRunes");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_Zilen = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,831,"Go_tardisgolib_Zilen");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_pushBooks = function(gr,_bds,p_x,p_y,p_state,p_cartLoad) {
	...
	this._t1 = false;
	this._t0 = 0.0;
	tardis.StackFrameBasis.call(this,gr,69,"Go_main_pushBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
tardis.Go_utf8_FullRune = function(gr,_bds,p_p) {
	...
	this._t3 = false;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,565,"Go_utf8_FullRune");
	this._bds = _bds;
	this.p_p = p_p;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_DecodeRuneInString = function(gr,_bds,p_s) {
	...
	this._t1 = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,591,"Go_utf8_DecodeRuneInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_UTF16toRunes = function(gr,_bds,p_s) {
	this._Next = 0;
	this._t0 = null;
	tardis.StackFrameBasis.call(this,gr,148,"Go_haxegoruntime_UTF16toRunes");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_CPos = function(gr,_bds) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,827,"Go_tardisgolib_CPos");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_pickBooks = function(gr,_bds,p_x,p_y,p_state,p_in) {
	this._Next = 0;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,62,"Go_main_pickBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
tardis._Go.Go_utf16_init = function(gr,_bds) {
	this._Next = 0;
	this._t0 = false;
	tardis.StackFrameBasis.call(this,gr,64,"Go_utf16_init");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_utf8_DecodeLastRuneInString = function(gr,_bds,p_s) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,638,"Go_utf8_DecodeLastRuneInString");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_haxegoruntime_Raw2Runes = function(gr,_bds,p_s) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,168,"Go_haxegoruntime_Raw2Runes");
	this._bds = _bds;
	this.p_s = p_s;
	tardis.Scheduler.push(gr,this);
};
...
tardis.Go_tardisgolib_StringsUTF8 = function(gr,_bds) {
	...
	this._t1 = false;
	this._t0 = 0;
	tardis.StackFrameBasis.call(this,gr,834,"Go_tardisgolib_StringsUTF8");
	this._bds = _bds;
	tardis.Scheduler.push(gr,this);
};
...
tardis._Go.Go_main_fireBooks = function(gr,_bds,p_x,p_y,p_state,p_cartLoad,p_out) {
	this._Next = 0;
	tardis.StackFrameBasis.call(this,gr,84,"Go_main_fireBooks");
	this._bds = _bds;
	this.p_x = p_x;
	this.p_y = p_y;
	this.p_state = p_state;
...
tardis.Go.CPos = function(pos) {
	...
	if(pos > 805) return prefix + "/Users/elliott/go/src/github.com/tardisgo/tardisgo/tardisgolib/tardisgolib.go:" + Std.string(pos - 805); else if(pos > 362) return prefix + "/usr/local/go/src/pkg/unicode/utf8/utf8.go:" + Std.string(pos - 362); else if(pos > 254) return prefix + "/usr/local/go/src/pkg/unicode/utf16/utf16.go:" + Std.string(pos - 254); else if(pos > 110) return prefix + "/Users/elliott/go/src/github.com/tardisgo/tardisgo/haxe/haxegoruntime/haxegoruntime.go:" + Std.string(pos - 110); else if(pos > 0) return prefix + "gophers.go:" + Std.string(pos); else return "(invalid pogo.PosHash:" + Std.string(pos) + ")";
}
...
tardis.Go.main_Sprite1X = new tardis.Pointer(0.0);
tardis.Go.main_Sprite2Y = new tardis.Pointer(0.0);
tardis.Go.main_Sprite1state = new tardis.Pointer(0);
tardis.Go.main_bigpile = new tardis.Pointer(null);
tardis.Go.main_oven = new tardis.Pointer(null);
tardis.Go.main_Sprite2state = new tardis.Pointer(0);
tardis.Go.main_smallpile = new tardis.Pointer(null);
tardis.Go.main_Sprite1Y = new tardis.Pointer(0.0);
tardis.Go.main_Sprite2X = new tardis.Pointer(0.0);
